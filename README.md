...
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/vinegm/.dotfiles/main/setup.sh)" -- -xwy
```
...
```bash
# X11 only
bash -c "$(curl -fsSL https://raw.githubusercontent.com/vinegm/.dotfiles/main/setup.sh)" -- -xy

# Wayland only
bash -c "$(curl -fsSL https://raw.githubusercontent.com/vinegm/.dotfiles/main/setup.sh)" -- -wy

# Base packages only (no desktop environment)
bash -c "$(curl -fsSL https://raw.githubusercontent.com/vinegm/.dotfiles/main/setup.sh)" -- -y
```
